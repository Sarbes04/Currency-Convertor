...
function App() {
  ...
  const currencyInfo = useCurrencyInfo(from); //gives json data

  const options = Object.keys(currencyInfo); //(currency options) gives all the keys for the from currency
